...
#define IMAGE_SENSOR_PV_WIDTH					(IMAGE_SENSOR_VGA_WIDTH - 8)  //all the resolutions seem to be correct
...
#define GC0309_WRITE_ID							0x42 //aproved
#define GC0309_READ_ID								0x43 //aproved
