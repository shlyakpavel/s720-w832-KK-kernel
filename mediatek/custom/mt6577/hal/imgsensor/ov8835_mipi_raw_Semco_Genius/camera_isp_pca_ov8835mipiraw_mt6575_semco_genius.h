...
PCA_LUTs:{
    lut_lo:{    // low
        ...
        { 0x00, 0xFE, 0x00, 0x00 }, // 43
        { 0x00, 0xFC, 0x00, 0x00 }, // 44
        { 0x00, 0xFA, 0x00, 0x00 }, // 45
        { 0x00, 0xF8, 0x00, 0x00 }, // 46
        { 0x00, 0xF6, 0x00, 0x00 }, // 47
        { 0x00, 0xF4, 0x00, 0x00 }, // 48
        { 0x00, 0xF2, 0x00, 0x00 }, // 49
        { 0x00, 0xF0, 0x00, 0x00 }, // 50
        { 0x00, 0xEE, 0x00, 0x00 }, // 51
        { 0x00, 0xF0, 0x00, 0x00 }, // 52
        { 0x00, 0xF2, 0x00, 0x00 }, // 53
        { 0x00, 0xF4, 0x00, 0x00 }, // 54
        { 0x00, 0xF6, 0x00, 0x00 }, // 55
        { 0x00, 0xF8, 0x00, 0x00 }, // 56
        { 0x00, 0xFA, 0x00, 0x00 }, // 57
        { 0x00, 0xFC, 0x00, 0x00 }, // 58
        { 0x00, 0xFC, 0x00, 0x00 }, // 59
        { 0x00, 0xFA, 0x00, 0x00 }, // 60
        { 0x00, 0xF8, 0xFE, 0x00 }, // 61
        { 0x00, 0xF6, 0xFC, 0x00 }, // 62
        { 0x00, 0xF4, 0xFA, 0x00 }, // 63
        { 0x00, 0xF2, 0xF8, 0x00 }, // 64
        { 0x00, 0xF0, 0xF6, 0x00 }, // 65
        { 0x00, 0xEE, 0xF4, 0x00 }, // 66
        { 0x00, 0xEC, 0xF2, 0x00 }, // 67
        { 0x00, 0xEA, 0xF0, 0x00 }, // 68
        { 0x00, 0xE8, 0xEE, 0x00 }, // 69
        { 0x00, 0xE6, 0xEC, 0x00 }, // 70
        { 0x00, 0xE4, 0xEA, 0x00 }, // 71
        { 0x00, 0xE2, 0xE8, 0x00 }, // 72
        { 0x00, 0xE0, 0xE6, 0x00 }, // 73
        { 0x00, 0xE2, 0xE8, 0x00 }, // 74
        { 0x00, 0xE4, 0xEA, 0x00 }, // 75
        { 0x00, 0xE6, 0xEC, 0x00 }, // 76
        { 0x00, 0xE8, 0xEE, 0x00 }, // 77
        { 0x00, 0xEA, 0xF0, 0x00 }, // 78
        { 0x00, 0xEC, 0xF2, 0x00 }, // 79
        { 0x00, 0xEE, 0xF4, 0x00 }, // 80
        { 0x00, 0xF0, 0xF6, 0x00 }, // 81
        { 0x00, 0xF2, 0xF8, 0x00 }, // 82
        { 0x00, 0xF4, 0xFA, 0x00 }, // 83
        { 0x00, 0xF6, 0xFC, 0x00 }, // 84
        { 0x00, 0xF8, 0xFE, 0x00 }, // 85
        { 0x00, 0xFA, 0x00, 0x00 }, // 86
        { 0x00, 0xFC, 0x00, 0x00 }, // 87
        { 0x00, 0xFE, 0x00, 0x00 }, // 88
    ...
    lut_hi:{    // high
        ...
        { 0x00, 0x00, 0x00, 0x00 }, // 63
        { 0x00, 0x00, 0x00, 0x00 }, // 64
        { 0x00, 0xFE, 0xFE, 0x00 }, // 65
        { 0x00, 0xFC, 0xFC, 0x00 }, // 66
        { 0x00, 0xFA, 0xFA, 0x00 }, // 67
        { 0x00, 0xF8, 0xF8, 0x00 }, // 68
        { 0x00, 0xF6, 0xF6, 0x00 }, // 69
        { 0x00, 0xF4, 0xF4, 0x00 }, // 70
        { 0x00, 0xF2, 0xF2, 0x00 }, // 71
        { 0x00, 0xF0, 0xF0, 0x00 }, // 72
        { 0x00, 0xEE, 0xEE, 0x00 }, // 73
        { 0x00, 0xEC, 0xEC, 0x00 }, // 74
        { 0x00, 0xEA, 0xEA, 0x00 }, // 75
        { 0x00, 0xE8, 0xE8, 0x00 }, // 76
        { 0x00, 0xE6, 0xE6, 0x00 }, // 77
        { 0x00, 0xE8, 0xE8, 0x00 }, // 78
        { 0x00, 0xEA, 0xEA, 0x00 }, // 79
        { 0x00, 0xEC, 0xEC, 0x00 }, // 80
        { 0x00, 0xEE, 0xEE, 0x00 }, // 81
        { 0x00, 0xF0, 0xF0, 0x00 }, // 82
        { 0x00, 0xF2, 0xF2, 0x00 }, // 83
        { 0x00, 0xF4, 0xF4, 0x00 }, // 84
        { 0x00, 0xF6, 0xF6, 0x00 }, // 85
        { 0x00, 0xF8, 0xF8, 0x00 }, // 86
        { 0x00, 0xFA, 0xFA, 0x00 }, // 87
        { 0x00, 0xFC, 0xFC, 0x00 }, // 88
        { 0x00, 0xFE, 0xFE, 0x00 }, // 89
        { 0x00, 0x00, 0x00, 0x00 }, // 90
        { 0x00, 0x00, 0x00, 0x00 }, // 91
        { 0x00, 0x00, 0x00, 0x00 }, // 92
        { 0x00, 0x00, 0x00, 0x00 }, // 93
        ...
        { 0x00, 0x00, 0x00, 0x00 }, // 157
        { 0x00, 0x00, 0x00, 0x00 }, // 158
        { 0x00, 0xFE, 0x00, 0x00 }, // 159
        { 0x00, 0xFC, 0x00, 0x00 }, // 160
        { 0x00, 0xFA, 0x00, 0x00 }, // 161
        { 0x00, 0xF8, 0x00, 0x00 }, // 162
        { 0x00, 0xF6, 0x00, 0x00 }, // 163
        { 0x00, 0xF4, 0x00, 0x00 }, // 164
        { 0x00, 0xF2, 0x00, 0x00 }, // 165
        { 0x00, 0xF0, 0x00, 0x00 }, // 166
        { 0x00, 0xEE, 0x00, 0x00 }, // 167
        { 0x00, 0xEC, 0x00, 0x00 }, // 168
        { 0x00, 0xEA, 0x00, 0x00 }, // 169
        { 0x00, 0xEC, 0x00, 0x00 }, // 170
        { 0x00, 0xEE, 0x00, 0x00 }, // 171
        { 0x00, 0xF0, 0x00, 0x00 }, // 172
        { 0x00, 0xF2, 0x00, 0x00 }, // 173
        { 0x00, 0xF4, 0x00, 0x00 }, // 174
        { 0x00, 0xF6, 0x00, 0x00 }, // 175
        { 0x00, 0xF8, 0x00, 0x00 }, // 176
        { 0x00, 0xFA, 0x00, 0x00 }, // 177
        { 0x00, 0xFC, 0x00, 0x00 }, // 178
        { 0x00, 0xFE, 0x00, 0x00 }, // 179
    }
}
