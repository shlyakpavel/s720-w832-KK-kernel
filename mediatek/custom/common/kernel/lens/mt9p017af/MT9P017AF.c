...
#define MT9P017AFDB(fmt, args...) printk(KERN_ERR"[MT9P017AF]%s %d : "fmt, __FUNCTION__, __LINE__, ##args)
#else
...
//static unsigned long g_u4MT9P017AF_MACRO = 0xff;
...
*/
//	a_u2Data = a_u2Data | 0x8000;
//	MT9P017AFDB("s4MT9P017AF_WriteReg1 =0x%x \n", a_u2Data);
//  	a_u2Data = a_u2Data & 0xff;
	a_u2Data = a_u2Data >>2;
//	MT9P017AFDB("s4MT9P017AF_WriteReg2 =0x%x \n", a_u2Data);
	MT9P017MIPI_write_cmos_sensor(0x30f2,a_u2Data);
//	MT9P017MIPI_write_cmos_sensor(0x30f0,a_u2Data);
    return 0;
}
