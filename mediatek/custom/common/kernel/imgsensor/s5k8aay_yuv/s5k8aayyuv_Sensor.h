...
#define S5K8AAYX_IMAGE_SENSOR_PV_WIDTH	 				    (1280-16) //fixed, correct value reversed from S5K8AAYGetResolution
#define S5K8AAYX_IMAGE_SENSOR_PV_HEIGHT					    (960-252) //fixed, correct value reversed from S5K8AAYGetResolution
...
#define S5K8AAYX_IMAGE_SENSOR_FULL_WIDTH			      (1280-16) //fixed, correct value reversed from S5K8AAYGetResolution
#define S5K8AAYX_IMAGE_SENSOR_FULL_HEIGHT			      (960-252)	//fixed, correct value reversed from S5K8AAYGetResolution
...
//export functions
UINT32 S5K8AAYOpen(void);
UINT32 S5K8AAYControl(MSDK_SCENARIO_ID_ENUM ScenarioId, MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *pImageWindow, MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData);
...
UINT32 S5K8AAYGetResolution(MSDK_SENSOR_RESOLUTION_INFO_STRUCT *pSensorResolution);
