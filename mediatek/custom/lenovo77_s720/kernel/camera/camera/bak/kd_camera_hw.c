...
if(currSensorName && ((0 == strcmp(SENSOR_DRVNAME_OV8825_MIPI_RAW,currSensorName))||(0 == strcmp(SENSOR_DRVNAME_OV8830_RAW,currSensorName))))  //zhaoshaopeng for sanglaishi and other 4e1 20120524
{
    //power ON
    if (On) {
        //in case
